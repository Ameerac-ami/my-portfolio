			...
			<section
				...
				<div className="flex max-w-4xl flex-col items-center text-center animate-fade-in">
					...
					<p
						...
						I build responsive, scalable, and high-performance interfaces using React, Next.js, and modern
						web technologies, with a certified background in full-stack development.
					</p>
