...
export default function SkillsSection() {
	const skillCategories = [
		...
		{
			title: "Backend",
			skills: ["Python", "Django", "Dart", "Node.js", "PostgreSQL", "Firebase", "FastAPI"],
			icon: (
				<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					<path
						strokeLinecap="round"
	...
	return (
		<section id="skills" className="w-full max-w-7xl px-6 py-26">
			<motion.div
				...
				<motion.p variants={itemVariants} className="max-w-2xl mx-auto text-slate-600 text-lg">
					A comprehensive overview of my technical stack and professional highlights.
				</motion.p>
			</motion.div>
			...
			<motion.div
				...
				<motion.div
					...
					<h3 className="mb-3 text-xl font-bold text-slate-900">Years Experience</h3>
					<p className="text-slate-600 leading-relaxed">
						Proven track record of building production-ready web applications with technical excellence.
					</p>
				...
				<motion.div
					...
					<h3 className="mb-3 text-xl font-bold text-slate-900">Specialized Stack</h3>
					<p className="text-slate-600 leading-relaxed">
						Deeply specialized in Next.js, React, and TypeScript for high-performance frontend solutions.
					</p>
				...
				<motion.div
					...
					<h3 className="mb-3 text-xl font-bold text-slate-900">Agile & Planning</h3>
					<p className="text-slate-600 leading-relaxed">
						Expertise in Agile methodology, project planning, and backlog grooming. Closely work with
						backend developers and UI designs to ensure seamless delivery.
					</p>
					{/* <div className="absolute -right-4 -bottom-4 h-24 w-24 rounded-full bg-accent/5 blur-2xl transition-all group-hover:bg-accent/10"></div> */}
				</motion.div>
			</motion.div>
