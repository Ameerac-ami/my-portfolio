			...
			<div className="mx-auto flex max-w-7xl items-center justify-between rounded-2xl border border-slate-200 bg-white/70 px-6 py-3 backdrop-blur-md shadow-sm">
				<button
					...
					<div className="relative h-10 w-10 overflow-hidden rounded-full border border-slate-200">
						<img src="/assets/images/profile.JPG" alt="Ameera" className="h-full w-full object-cover" />
					</div>
				...
				{/* <button className="rounded-xl bg-[#bfbfbfd2] px-5 py-2 text-sm font-semibold text-black transition-all flex items-center gap-2 hover:bg-slate-800 hover:shadow-lg focus:outline-none">
